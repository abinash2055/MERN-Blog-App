            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <div className='mb-3'>
                <FormField control={form.control} name="category" render={({ field }) => {
                  const selectedCategory = categoryData?.category?.find(cat => cat._id === field.value);
              ...
              {/* Text CK Editor */}
              <div className='mb-3'>
                <FormField control={form.control} name="blogContent" render={({ field }) => (
                  <FormItem>
                    <FormLabel>Blog Content</FormLabel>
                    <FormControl>
                      <Editor props={{ initialDaata: "", onChange: handleEditorData }} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
              ...
              <Button type="submit" className="w-full cursor-pointer">Add Blog</Button>
            </form>
          </Form>
        </CardContent>
      </Card>
